"""
Test script: Search for Raytheon awards in 2023 for guided missiles and print any attached subawards.
...
def main():
    print("Searching for Raytheon awards in 2023 for guided missiles...")
    with USASpendingClient() as client:
        awards_query = client.awards.search() \
            .recipient_search_text("Raytheon") \
            .contracts() \
            .fiscal_year(2023) \
            .keywords("guided missile", "missile", "munitions") \
